...
def myNetwork():
	...
	cpuperc=random.random()
	if i<10:
	    host=net.addHost('h'+str(i), cls=Host, ip='10.0.0.'+str(i),
	    defaultRoute=None,mac="00:00:00:00:00:0"+str(i),cpu=cpuperc)
	elif i<100:
	    host=net.addHost('h'+str(i), cls=Host, ip='10.0.0.'+str(i),
	    defaultRoute=None,mac="00:00:00:00:00:"+str(i),cpu=cpuperc)
	else:  
	    host=net.addHost('h'+str(i), cls=Host, ip='10.0.0.'+str(i),
	    defaultRoute=None,mac="00:00:00:00:0"+str(i[0])+":"+str(i[1:]),cpu=cpuperc)
	hosts.append(host)
	...
	for j in range(0,perswitch):
	    ...
	    delayms=random.randint(1,10)
	    losslvl=random.randint(1,10)
	    net.addLink(i,hosts[j],cls=TCLink,delay=str(delayms)+"ms",bw=bandwidth,use_htb=True,loss=losslvl)
	del hosts[:perswitch]
